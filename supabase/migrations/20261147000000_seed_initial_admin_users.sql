...
-- auth.identities, public.profiles, and public.user_roles.
-- This ensures that whenever migrations are pushed (supabase db push / CI/CD),
-- the system administrator is automatically created and ready for sign-in.
-- ============================================================================
