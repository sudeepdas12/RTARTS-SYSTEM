-- =========================================================
-- Migration: Add nid_number (National Identity Number) to clients table
-- =========================================================

ALTER TABLE public.clients
  ADD COLUMN IF NOT EXISTS nid_number TEXT;

-- Update bulk_insert_clients RPC to support nid_number and preserve existing value on update
  ...
  LOOP
    BEGIN
      INSERT INTO public.clients (
        ...
        father_name, grandfather_name, pan_or_citizenship, nid_number,
