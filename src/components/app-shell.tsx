...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset>
        <header className="sticky top-0 z-10 flex h-14 items-center gap-3 border-b glass px-4 shrink-0 transition-colors">
          <SidebarTrigger />
          <Breadcrumbs />
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="glass-card">
              ...
              <DropdownMenuItem
                onClick={signOut}
                className="text-destructive focus:bg-destructive/10 cursor-pointer transition-colors"
              >
        ...
        <div className="flex-1 p-6 overflow-auto min-w-0 animate-fade-in">{children}</div>
      </SidebarInset>
