...
describe("IafGeneratorService — CDSC Allotment Engine", () => {
  ...
  describe("formatIafDetailLine", () => {
    ...
    it("creates exact 124-character CDSC Detail Record for Free Public Shares", () => {
      ...
      expect(line.length).toBe(124);
      expect(line).toBe(
        "1301150000048068000000000100.000000000000000.00000                                                  00000000     RBBF4008283",
      );
  ...
  describe("IPF Corporate Action Format (9896.011.ipf Spec)", () => {
    ...
    it("creates exact 274-character IPF Detail Record", () => {
      ...
      expect(line).toBe(
        "1301480000009177R-100% FY-080/81NPE254A00000000000000000.000000000000000.000000000000000.00000                                                  00000000CNPE254A00000000000000590.000000000000000.000000000000000.00000                                                  00000000C",
      );
    });
  });
});
